...
--controller
local sim_time_total=31 --34
local sim_time_steps=187 --206
...
local function controller(u_cmd,y)
    ...
    -- gcs:send_text(1,"input command calculated")
        ...
        local dthr_rf = clamp((AG.Kpr_m*roll    + AG.Kdr_m*rollr) * sx, AG.dthr_max)  -- us, front
        local dthr_rr = clamp((AG.Kpr_m*roll    + AG.Kdr_m*rollr),      AG.dthr_max)  -- us, rear
